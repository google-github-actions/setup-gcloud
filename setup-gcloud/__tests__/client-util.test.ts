...
describe('queryGcloudSDKRelease tests', () => {
    it('Finds matching version linux', async () => {
        ...
        expect(release!.name).toBe(`google-cloud-sdk-${testUtil.TEST_SDK_VERSION}-linux-x86_64.tar.gz`);
    ...
    it('Finds matching version windows', async () => {
        ...
        expect(release).toBeDefined();
        expect(release!.name).toBe(`google-cloud-sdk-${testUtil.TEST_SDK_VERSION}-windows-x86_64.zip`);
        expect(release!.version).toBe(testUtil.TEST_SDK_VERSION);
        expect(release!.url).toEqual(
            expect.stringContaining(
    ...
    it('Finds matching version darwin', async () => {
        ...
        expect(release).toBeDefined();
        expect(release!.name).toBe(`google-cloud-sdk-${testUtil.TEST_SDK_VERSION}-darwin-x86_64.tar.gz`);
        expect(release!.version).toBe(testUtil.TEST_SDK_VERSION);
        expect(release!.url).toEqual(
            expect.stringContaining(
