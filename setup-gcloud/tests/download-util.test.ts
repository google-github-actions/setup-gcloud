...
describe('#downloadAndExtractTool', () => {
  ...
  it('downloads and extracts linux version', async () => {
  ...
  it('downloads and extracts windows version', async () => {
  ...
  it('downloads and extracts darwin version', async () => {
  ...
  it('errors on download not found', async () => {
    downloadUtil
